...
# ==========================================
# 📚 ฐานข้อมูลหลักสูตร (Master Database ป.5 - ฉบับสมบูรณ์พร้อมสอบแข่งขัน)
# ==========================================
curriculum_db = {
    "ป.5": {
        "จำนวนนับและการดำเนินการ": [
        ...
        "เตรียมสอบเข้า ม.1 (Gifted)": [
            "ทฤษฎีจำนวน (จำนวนเฉพาะ, ตัวประกอบ, การหารลงตัว)",
            "โจทย์ปัญหา ห.ร.ม. และ ค.ร.น. (แบ่งของ, นาฬิกาปลุก)", 
            "โจทย์ปัญหาอายุ และ การทำงานร่วมกัน", 
            "โจทย์ปัญหาคลาสสิก (นับขาสัตว์, เหรียญ)", 
            "โจทย์ปัญหาเศษส่วนต่อเนื่อง (ของที่เหลือ)", 
            "เลขยกกำลังเบื้องต้นและหลักหน่วย",
            "อัตราเร็ว ระยะทาง และเวลา (รถไฟข้ามสะพาน, กระแสน้ำ)", # ✨ อัปเกรด
            "แบบรูปและอนุกรม (Number Patterns)", 
            "มาตราส่วนและทิศทาง", 
            "เรขาคณิตประยุกต์ (หาพื้นที่แรเงาเชิงซ้อน)",
            "เซตและแผนภาพเวนน์-ออยเลอร์ (Venn Diagram)", # ✨ เพิ่มใหม่
            "โอเปอเรชันและเครื่องหมายสมมติ (Operation)", # ✨ เพิ่มใหม่
            "มุมระหว่างเข็มนาฬิกา (Clock Angles)", # ✨ เพิ่มใหม่
            "หลักการนับเบื้องต้น (การแข่งขันพบกันหมด, จัดชุดเสื้อผ้า)" # ✨ เพิ่มใหม่
        ]
    }
}
